                                            ...
                                            <div class="topbar-links">
                                                ...
                                                <div class="header-cart dropdown">
                                                    ...
                                                    <div class="dropdown-menu cart-dropdown">
                                                        <ul>
                                                            <li class="clearfix">
                                                                <img src="///header-cart-image-01.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                            ...
                                                            <li class="clearfix">
                                                                <img src="///header-cart-image-02.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                                        <a href="#">The Great Gatsby</a>
                                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="company-detail bg-dark margin-left">
                                                        ...
                                                        {{-- 
                                                            ...
                                                            NIM : 2440046031
                                                        --}}
                                                        <form class="login" method="POST" enctype="multipart/form-data" action="{{ route('save_reg') }}">
                                                            @csrf
                                                            <p class="form-row form-row-first input-required">
                                                                <label>
                                                                    <span class="first-letter">Fullname</span>  
                                                             ...
                                                             <p class="form-row form-row-first input-required">
                                                                <label>
                                                                    <span class="first-letter">NIM</span>  
                                                                    <span class="second-letter">*</span>
                                                                </label>
                                                                <input type="text"  id="nim" name="nim" class="input-text" required>
                                                             </p>
                                                             <p class="form-row form-row-first input-required">
                                                                <label>
                                                            ...
                                                            <div class="clear"></div>
                                                            <input type="submit" value="register" name="register" class="button btn btn-default">
                                                            <div class="clear"></div>
                                                        </form>
                                                    </div>
                                                </div>
